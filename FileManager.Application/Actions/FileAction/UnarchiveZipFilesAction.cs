...
public class UnarchiveZipFilesAction(Menu menu, FileManagerContext context) : IAction
{
    ...
    public void Execute(string command)
    {
        ...
        var fullPathNameFileArchive = Path.Combine(menu.CurrentPath, nameFileArchive);
        ...
        var fullPathArchiveDirectory = Path.Combine(menu.CurrentPath, nameFileDirectory);
