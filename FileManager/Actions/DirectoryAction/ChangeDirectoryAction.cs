...
public class ChangeDirectoryAction(Menu menu, DirectoryPath directoryPath) : IAction
{
    ...
    public void Execute(string command)
    {
        ...
        var fullPath = Path.Combine(menu.CurrentPath, nameDirectory);
    ...
    private void MoveDirectory(string fullPath)
    {
        ...
        menu.CurrentPath = fullPath;
    }

    private void MoveDirectoryBelow()
    {
        var pathWithoutLastDirectory = directoryPath.GetDirectoryBelow();
        menu.CurrentPath = pathWithoutLastDirectory;
    }
}